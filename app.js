  ...
  function processData() {
    ...
    data = data.map(row => {
      ...
      return {
        ...
        REGIMEN: __normalizeRegimen__(row['RÉGIMEN'] || row.REGIMEN || ''),
        TIPOLOGIA: row.TIPOLOGIA || '',
        ZONA_INEC: row.ZONA_INEC || '',
        NIVEL_DE_EDUCACION: row.NIVEL_DE_E || row.NIVEL_DE_EDUCACION || '',
        AUX_ANIO_DOTACION: String(row['AÑO_DE_DO'] || row.AUX_ANIO_DOTACION || '').trim(),
        LATITUD: lat,
        LONGITUD: lng,
