...
const esriSat = L.tileLayer(
  ...
  { maxZoom: 19, attribution: "Tiles &copy; Esri — Source: Esri, Maxar, Earthstar Geographics, etc." }
);

// Control de capas (basemaps)
L.control.layers(
  { "OSM": osm, "Satélite (Esri)": esriSat },
  {},
...
async function refreshData(){
  ...
  (data || [])
    ...
    .forEach(r => {
      const m = L.circleMarker([r.lat, r.lon], redDotStyle)
